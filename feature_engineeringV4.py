...
for _, row in df.iterrows():
    ...
    # =====================================
    # 6. Finger Extension Distances (5)
    # =====================================

    for tip in tips:

        dx = coords[tip][0] - wrist[0]
        dy = coords[tip][1] - wrist[1]
